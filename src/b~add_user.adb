pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~add_user.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~add_user.adb");
...
package body ada_main is
   ...
   E119 : Short_Integer; pragma Import (Ada, E119, "apq_E");
